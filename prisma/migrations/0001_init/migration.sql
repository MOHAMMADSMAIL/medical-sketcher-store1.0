...
-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('DRAFT', 'PUBLISHED', 'COMING_SOON');
...
CREATE TABLE "DownloadPermission" (
    ...
    CONSTRAINT "DownloadPermission_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "DownloadPermission_userId_productId_key" ON "DownloadPermission"("userId", "productId");
...
-- AddForeignKey
ALTER TABLE "DownloadPermission" ADD CONSTRAINT "DownloadPermission_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DownloadPermission" ADD CONSTRAINT "DownloadPermission_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DownloadLog" ADD CONSTRAINT "DownloadLog_permissionId_fkey" FOREIGN KEY ("permissionId") REFERENCES "DownloadPermission"("id") ON DELETE CASCADE ON UPDATE CASCADE;
